...
target_data_classified <- target_data1 %>%
  mutate(Classification = case_when(
    weekly_rate > 0 & weekly_rate < count_rate1 ~ "stable",
    weekly_rate > 0 & observation < 10 ~ "stable",
    weekly_rate > 0 & weekly_rate < count_rate2 ~ "increase",
    weekly_rate > 0 & weekly_rate >= count_rate2 ~ "large increase",
    weekly_rate < 0 & abs(weekly_rate) < count_rate2 ~ "decrease",
    weekly_rate < 0 & abs(weekly_rate) >= count_rate2 ~ "large decrease"
  )) %>%
