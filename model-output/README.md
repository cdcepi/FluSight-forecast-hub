...
For the peak week target, the `output_type_id` should specify the last Saturday of each epidemic week in the season (2026-10-10 to 2027-05-29) in ISO format: YYYY-MM-DD.
